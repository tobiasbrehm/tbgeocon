...
def home (request):
    ...
    if request.method == 'POST':
        ...
        if 'submitted' in request.GET:
            submitted = Tru
    return render (request,'home.html', {'about': about, 'mining': mining,'polar': polar,'photo': photo,'translations': translations,'contact': contact, 'sections': sections, 'form_de': form_de, 'form': form, 'submitted': submitted})